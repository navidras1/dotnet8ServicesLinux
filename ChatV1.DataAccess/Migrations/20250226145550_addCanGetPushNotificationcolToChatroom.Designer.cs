...
namespace ChatV1.DataAccess.Migrations
{
    ...
    [Migration("20250226145550_addCanGetPushNotificationcolToChatroom")]
    partial class addCanGetPushNotificationcolToChatroom
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatV1.DataAccess.Models.ChatLog", b =>
                {
                    ...
                    b.HasIndex("FromUserName", "ToUserName", "ChatGuid");
            ...
            modelBuilder.Entity("ChatV1.DataAccess.Models.ChatRoom", b =>
                {
                    ...
                    b.Property<bool?>("CanGetPushNotification")
                        .HasColumnType("boolean");

                    b.Property<long?>("ChatRoomLogoId")
                        .HasColumnType("bigint");
